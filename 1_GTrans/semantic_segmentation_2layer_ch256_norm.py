...
from visual_transformer_noxin import FilterBasedTokenizer, Transformer, Projector, RecurrentTokenizer, Transformer_Decoder
...
class VT_FPN(nn.Module):
    ...
    def forward(self, X):
        ...
        decoder_1 = self.Decoder(all_token_t, encoder_s2)
        decoder_2 = self.Decoder(decoder_1, encoder_s2)
        t2, t3, t4 = torch.split(decoder_2, self.n_visual_tokens, dim=2)
