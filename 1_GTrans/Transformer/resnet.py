...
def modified_resnet34(pretrained=True, progress=True, **kwargs):
    return modified_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                           **kwargs)

def modified_resnet50_2(pretrained=True, progress=True, **kwargs):
    kwargs['width_per_group'] = 64 * 2
    return modified_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
